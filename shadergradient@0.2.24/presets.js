// src/presets.ts
var DEFAUlT_PRESET = "?pixelDensity=1&cDistance=1";
var PRESETS = [
  {
    title: "Halo",
    color: "white",
  ...
  },
  {
    title: "Pensive",
    color: "white",
    url: "?animate=on&axesHelper=off&brightness=1.5&cAzimuthAngle=250&cDistance=1.6&cPolarAngle=140&cameraPositionX=0&cameraPositionY=0&cameraPositionZ=0&cameraZoom=9.2&color1=%23809bd6&color2=%23910aff&color3=%23af38ff&embedMode=off&envPreset=city&gizmoHelper=hide&grain=on&lightType=3d&pixelDensity=1&positionX=0&positionY=0&positionZ=0&reflection=0.5&rotationX=0&rotationY=0&rotationZ=140&shader=defaults&type=sphere&uAmplitude=7&uDensity=0.8&uFrequency=5.5&uSpeed=0.3&uStrength=0.4&uTime=0&wireframe=false"
  },
  {
    title: "Mint",
    color: "white",
    url: "?animate=on&axesHelper=off&brightness=1.2&cAzimuthAngle=170&cDistance=4.4&cPolarAngle=70&cameraPositionX=0&cameraPositionY=0&cameraPositionZ=0&cameraZoom=1&color1=%2394ffd1&color2=%236bf5ff&color3=%23ffffff&embedMode=off&envPreset=city&gizmoHelper=hide&grain=off&lightType=3d&pixelDensity=1&positionX=0&positionY=0.7&positionZ=0&reflection=0.1&rotationX=45&rotationY=0&rotationZ=0&type=waterPlane&uAmplitude=0&uDensity=1.2&uFrequency=0&uSpeed=0.2&uStrength=3.4&uTime=0&wireframe=false"
  },
  {
    title: "Interstella",
    color: "white",
    url: "?animate=on&axesHelper=off&brightness=0.8&cAzimuthAngle=270&cDistance=0.5&cPolarAngle=180&cameraPositionX=0&cameraPositionY=0&cameraPositionZ=0&cameraZoom=9.8&color1=%2373bfc4&color2=%23ff810a&color3=%238da0ce&embedMode=off&envPreset=city&gizmoHelper=hide&grain=on&lightType=env&pixelDensity=1&positionX=-0.1&positionY=0&positionZ=0&reflection=0.4&rotationX=0&rotationY=130&rotationZ=70&shader=defaults&type=sphere&uAmplitude=3.2&uDensity=0.8&uFrequency=5.5&uSpeed=0.3&uStrength=0.3&uTime=0&wireframe=false"
  },
  {
    title: "Nighty night",
    color: "white",
  ...
  },
  {
    title: "Universe",
    color: "white",
    url: "?animate=on&axesHelper=on&brightness=1.3&cAzimuthAngle=180&cDistance=3.9&cPolarAngle=125&cameraPositionX=0&cameraPositionY=0&cameraPositionZ=0&cameraZoom=1&color1=%235606FF&color2=%23FE8989&color3=%23000000&embedMode=off&envPreset=city&grain=off&lightType=3d&pixelDensity=1&positionX=-0.5&positionY=-0.3&positionZ=0&reflection=0.1&rotationX=0&rotationY=0&rotationZ=235&type=waterPlane&uAmplitude=0&uDensity=1.1&uSpeed=0.1&uStrength=2.4&uTime=0.2&wireframe=false"
  },
  {
    title: "Sunset",
    color: "white",
  ...
  },
  {
    title: "Mandarin",
    color: "white",
    url: "?animate=on&axesHelper=on&brightness=1.2&cAzimuthAngle=180&cDistance=2&cPolarAngle=95&cameraPositionX=0&cameraPositionY=0&cameraPositionZ=0&cameraZoom=1&color1=%23ff6a1a&color2=%23000000&color3=%23FD4912&embedMode=off&envPreset=city&grain=off&lightType=3d&pixelDensity=1&positionX=-0.1&positionY=-3.2&positionZ=0&reflection=0.1&rotationX=0&rotationY=0&rotationZ=225&shader=defaults&type=waterPlane&uAmplitude=0&uDensity=1.8&uSpeed=0.2&uStrength=3&uTime=0.2&wireframe=false"
  },
  {
    title: "Cotton Candy",
    color: "white",
