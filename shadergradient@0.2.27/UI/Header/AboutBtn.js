...
var require_link = __commonJS({
  "../../node_modules/next/dist/client/link.js"(exports) {
    ...
    function Link2(props) {
      ...
      const router2 = (0, _router1).useRouter();
      const { href, as } = _react.default.useMemo(() => {
        const [resolvedHref, resolvedAs] = (0, _router).resolveHref(router2, props.href, true);
        return {
          href: resolvedHref,
          as: props.as ? (0, _router).resolveHref(router2, props.as) : resolvedAs || resolvedHref
        };
      }, [
        router2,
        props.href,
      ...
      if (props.passHref || child.type === "a" && !("href" in child.props)) {
        const curLocale = typeof locale !== "undefined" ? locale : router2 && router2.locale;
        const localeDomain = router2 && router2.isLocaleDomain && (0, _router).getDomainLocale(as, curLocale, router2 && router2.locales, router2 && router2.domainLocales);
        childProps.href = localeDomain || (0, _router).addBasePath((0, _router).addLocale(as, curLocale, router2 && router2.defaultLocale));
      }
...
function AboutBtn({ inAbout = false, color = "white", onClick }) {
  ...
  return /* @__PURE__ */ React.createElement(motion.div, {
    ...
    style: { display: "flex" },
    onClick: () => {
      import_router.default.back();
    }
  }, /* @__PURE__ */ React.createElement("p", {
    style: { transform: "rotate(-135deg)" }
  }, "\u2191"), /* @__PURE__ */ React.createElement("p", null, " back")) : /* @__PURE__ */ React.createElement(import_link.default, {
    href: "/about"
