...
`;continue}if((F=H.match(b))&&(z.gamma=parseFloat(F[1])),(F=H.match(L))&&(z.exposure=parseFloat(F[1])),(F=H.match(C))&&(z.valid|=2,z.format=F[1]),(F=H.match(O))&&(z.valid|=4,z.height=parseInt(F[1],10),z.width=parseInt(F[2],10)),z.valid&2&&z.valid&4)break}return z.valid&2||n(3,"missing format specifier"),z.valid&4||n(3,"missing image size specifier"),z},d=function(u,E,b){let L=E;if(L<8||L>32767||u[0]!==2||u[1]!==2||u[2]&128)return new Uint8Array(u);L!==(u[2]<<8|u[3])&&n(3,"wrong scanline width");let C=new Uint8Array(4*E*b);C.length||n(4,"unable to allocate buffer space");let O=0,z=0,H=4*L,F=new Uint8Array(4),Te=new Uint8Array(H),fr=b;for(;fr>0&&z<u.byteLength;){z+4>u.byteLength&&n(1),F[0]=u[z++],F[1]=u[z++],F[2]=u[z++],F[3]=u[z++],(F[0]!=2||F[1]!=2||(F[2]<<8|F[3])!=L)&&n(3,"bad rgbe scanline format");let Fe=0,ae;for(;Fe<H&&z<u.byteLength;){ae=u[z++];let se=ae>128;if(se&&(ae-=128),(ae===0||Fe+ae>H)&&n(3,"bad scanline data"),se){let ce=u[z++];for(let dr=0;dr<ae;dr++)Te[Fe++]=ce}else Te.set(u.subarray(z,z+ae),Fe),Fe+=ae,z+=ae}let _i=L;for(let se=0;se<_i;se++){let ce=0;C[O]=Te[se+ce],ce+=L,C[O+1]=Te[se+ce],ce+=L,C[O+2]=Te[se+ce],ce+=L,C[O+3]=Te[se+ce],O+=4}fr--}return C},T=function(u,E,b,L){let C=u[E+3],O=Math.pow(2,C-128)/255;b[L+0]=u[E+0]*O,b[L+1]=u[E+1]*O,b[L+2]=u[E+2]*O,b[L+3]=1},x=function(u,E,b,L){let C=u[E+3],O=Math.pow(2,C-128)/255;b[L+0]=X.DataUtils.toHalfFloat(Math.min(u[E+0]*O,65504)),b[L+1]=X.DataUtils.toHalfFloat(Math.min(u[E+1]*O,65504)),b[L+2]=X.DataUtils.toHalfFloat(Math.min(u[E+2]*O,65504)),b[L+3]=X.DataUtils.toHalfFloat(1)},P=new Uint8Array(e);P.pos=0;let y=v(P),h=y.width,G=y.height,U=d(P.subarray(P.pos),h,G),m,S,R;switch(this.type){case X.FloatType:R=U.length/4;let u=new Float32Array(R*4);for(let b=0;b<R;b++)T(U,b*4,u,b*4);m=u,S=X.FloatType;break;case X.HalfFloatType:R=U.length/4;let E=new Uint16Array(R*4);for(let b=0;b<R;b++)x(U,b*4,E,b*4);m=E,S=X.HalfFloatType;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:h,height:G,data:m,header:y.string,gamma:y.gamma,exposure:y.exposure,type:S}}setDataType(e){return this.type=e,this}load(e,t,o,i){function a(n,s){switch(n.type){case X.FloatType:case X.HalfFloatType:"colorSpace"in n?n.colorSpace="srgb-linear":n.encoding=3e3,n.minFilter=X.LinearFilter,n.magFilter=X.LinearFilter,n.generateMipmaps=!1,n.flipY=!0;break}t&&t(n,s)}return super.load(e,a,o,i)}};var bo=require("@react-three/fiber");function yt(r,{path:e}){return(0,bo.useLoader)(Ke,r,o=>o.setPath(e))}var en=r=>r.current&&r.current.isScene,tn=r=>en(r)?r.current:r;function Ro({background:r=!1,envPreset:e}){let t=yt("city.hdr",{path:et}),o=yt("dawn.hdr",{path:et}),i=yt("lobby.hdr",{path:et}),n={city:t,dawn:o,lobby:i}[e],s=(0,zo.useThree)(l=>l.scene);Po.default.useLayoutEffect(()=>{if(n){let l=tn(s),g=l.background,p=l.environment;return r!=="only"&&(l.environment=n),r&&(l.background=n),()=>{r!=="only"&&(l.environment=p),r&&(l.background="black")}}},[s,n,r]);let c=n;return c.mapping=Co.EquirectangularReflectionMapping,null}var xt=require("react");var Ao=require("react"),$t=require("three");var Wt=0;function wo(){let[r,e]=(0,Ao.useState)({});return $t.DefaultLoadingManager.onLoad=()=>{e(t=>$(w({},t),{active:!1}))},$t.DefaultLoadingManager.onProgress=(t,o,i)=>{o===i&&(Wt=i);let a=(o-Wt)/(i-Wt)*100||100;e(n=>$(w({},n),{active:!0,item:t,loaded:o,total:i,progress:a}))},r}var ne=require("react/jsx-runtime");function Lo({lightType:r,brightness:e,envPreset:t}){return(0,ne.jsxs)(ne.Fragment,{children:[r==="3d"&&(0,ne.jsx)("ambientLight",{intensity:e||1}),r==="env"&&(0,ne.jsx)(xt.Suspense,{fallback:(0,ne.jsx)(rn,{}),children:(0,ne.jsx)(Ro,{envPreset:t,background:!1,loadingCallback:()=>{}})})]})}function rn(){let{progress:r}=wo();return(0,xt.useEffect)(()=>{let e=document.getElementById("LoaderRoot");e&&r&&(r===100?(e.innerHTML="Ligths are loaded",setTimeout(()=>{e.innerHTML=""},1e3)):e.innerHTML="Loading lights...")},[r]),(0,ne.jsx)("ambientLight",{intensity:.4})}var We=require("@react-spring/three");var rr=require("@react-three/fiber"),Rt=require("react");var Et=J(require("three"));function Oo(r,e,t){return class extends Et.LineBasicMaterial{constructor(){let o=Object.entries(r),i=o.reduce((a,[n,s])=>{let c=Et.UniformsUtils.clone({[n]:{value:s}});return w(w({},a),c)},{});super({color:"#ffffff",linewidth:5,userData:i,onBeforeCompile:a=>{a.uniforms=w(w({},a.uniforms),i),a.vertexShader=e}}),o.forEach(([a])=>Object.defineProperty(this,a,{get:()=>this.uniforms[a].value,set:n=>this.uniforms[a].value=n})),t&&t(this)}}}var Oe=J(require("three"));function Do(r,e,t,o){return class extends Oe.MeshPhysicalMaterial{constructor(){let i=Object.entries(r),a=r.colors,n=Jt(a[0]),s=Jt(a[1]),c=Jt(a[2]),l={uC1r:{value:ue(n==null?void 0:n.r)},uC1g:{value:ue(n==null?void 0:n.g)},uC1b:{value:ue(n==null?void 0:n.b)},uC2r:{value:ue(s==null?void 0:s.r)},uC2g:{value:ue(s==null?void 0:s.g)},uC2b:{value:ue(s==null?void 0:s.b)},uC3r:{value:ue(c==null?void 0:c.r)},uC3g:{value:ue(c==null?void 0:c.g)},uC3b:{value:ue(c==null?void 0:c.b)}},g=i.reduce((p,[v,d])=>{let T=Oe.UniformsUtils.clone({[v]:{value:d}});return w(w({},p),T)},{});super({metalness:.2,userData:g,side:Oe.DoubleSide,onBeforeCompile:p=>{p.uniforms=w(w(w({},p.uniforms),g),l),p.vertexShader=e,p.fragmentShader=t}}),i.forEach(([p])=>Object.defineProperty(this,p,{get:()=>this.uniforms[p].value,set:v=>this.uniforms[p].value=v})),o&&o(this)}}}function Jt(r){let e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(r);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null}function ue(r=0){return r/255}var tr={};re(tr,{defaults:()=>Qe,positionMix:()=>er});var Qe={};re(Qe,{plane:()=>Tt,sphere:()=>St,waterPlane:()=>bt});var Tt={};re(Tt,{fragment:()=>Fo,vertex:()=>Mo});var Fo=`
#define STANDARD
#ifdef PHYSICAL
#define REFLECTIVITY
#define CLEARCOAT
...
vUv=uv;float t=uTime*uSpeed;float distortion=0.75*cnoise(0.43*position*uNoiseDensity+t);vec3 pos=position+normal*distortion*uNoiseStrength*uLoadingTime;vPos=pos;gl_Position=projectionMatrix*modelViewMatrix*vec4(pos,1.);}`;var St={};re(St,{fragment:()=>Io,vertex:()=>No});var Io=`
#define STANDARD
#ifdef PHYSICAL
#define REFLECTIVITY
#define CLEARCOAT
...
#include <shadowmap_vertex>
#include <worldpos_vertex>
vUv=uv;float t=uTime*uSpeed;float distortion=0.75*cnoise(0.43*position*uNoiseDensity+t);vec3 pos=position+normal*distortion*uNoiseStrength*uLoadingTime;vPos=pos;gl_Position=projectionMatrix*modelViewMatrix*vec4(pos,1.);}`;var Ct={};re(Ct,{fragment:()=>Vo,vertex:()=>ko});var Vo=`
#define STANDARD
#ifdef PHYSICAL
#define REFLECTIVITY
#define CLEARCOAT
