...
function Lights({
  ...
  return /* @__PURE__ */ jsxs(Fragment2, { children: [
    lightType === "3d" && /* @__PURE__ */ jsx3("ambientLight", { intensity: (brightness || 1) * Math.PI }),
    lightType === "env" && /* @__PURE__ */ jsx3(Suspense2, { fallback: /* @__PURE__ */ jsx3(Loader2, {}), children: /* @__PURE__ */ jsx3(
      EnvironmentMap,
      {
        envPreset,
        background: false,
...
function Loader2() {
  return /* @__PURE__ */ jsx3("ambientLight", { intensity: 0.4 });
}
export {
  Lights
};
