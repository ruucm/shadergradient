...
function ShaderGradientCanvas({
  ...
  useShaderChunkFix();
  return /* @__PURE__ */ jsx("div", { ref: containerRef, children: !lazyLoad || isInView ? /* @__PURE__ */ jsx(Context.Provider, { value: contextValue, children: /* @__PURE__ */ jsx(
    Canvas,
