...
function ShaderGradientCanvas({
  ...
  return /* @__PURE__ */ jsx("div", { ref: containerRef, style: __spreadValues({ width: "100%", height: "100%" }, style), children: shouldRender && /* @__PURE__ */ jsx(Context.Provider, { value: contextValue, children: /* @__PURE__ */ jsx(
    Canvas,
