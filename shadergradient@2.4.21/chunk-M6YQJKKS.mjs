...
import { Mesh, InstancedInterleavedBuffer as InstancedInterleavedBuffer2, InterleavedBufferAttribute as InterleavedBufferAttribute2, Vector4, Vector3 as Vector32, Box3 as Box32, Sphere as Sphere2, MathUtils, Matrix4, Line3 } from "three";
...
var _ssOrigin3 = /* @__PURE__ */ new Vector32();
var _mvMatrix = /* @__PURE__ */ new Matrix4();
var _line = /* @__PURE__ */ new Line3();
var _closestPoint = /* @__PURE__ */ new Vector32();
...
var LineSegments2 = class extends Mesh {
  ...
  computeLineDistances() {
    ...
    const instanceDistanceBuffer = new InstancedInterleavedBuffer2(lineDistances, 2, 1);
