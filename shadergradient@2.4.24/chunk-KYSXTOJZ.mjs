...
// sched-prod:/home/runner/work/shadergradient/shadergradient/main/node_modules/.pnpm/scheduler@0.21.0/node_modules/scheduler/cjs/scheduler.production.min.js
...
var Q = -1;
function M() {
  return exports4.unstable_now() - Q < P ? false : true;
}
function R() {
  if (null !== O) {
...
exports4.unstable_requestPaint = function() {
};
...
exports4.unstable_shouldYield = M;
