...
var require_setPrototypeOf = __commonJS({
  "../../node_modules/.pnpm/@babel+runtime@7.26.7/node_modules/@babel/runtime/helpers/setPrototypeOf.js"(exports2, module2) {
...
var require_inheritsLoose = __commonJS({
  "../../node_modules/.pnpm/@babel+runtime@7.26.7/node_modules/@babel/runtime/helpers/inheritsLoose.js"(exports2, module2) {
...
var require_extends = __commonJS({
  "../../node_modules/.pnpm/@babel+runtime@7.26.7/node_modules/@babel/runtime/helpers/extends.js"(exports2, module2) {
    function _extends8() {
...
var require_objectWithoutPropertiesLoose = __commonJS({
  "../../node_modules/.pnpm/@babel+runtime@7.26.7/node_modules/@babel/runtime/helpers/objectWithoutPropertiesLoose.js"(exports2, module2) {
...
function TextAnimation({
  ...
  const [activePresetInView, setActivePresetInView] = (0, import_react2.useState)(false);
...
var p = function(p2) {
  function u2(e2) {
    ...
    return a2.resizeObserver = null, a2.resizeElementRef = import_react3.default.createRef(), a2.state = { index: -1, upperBound: 0, sliderLength: 0, value: u3, zIndices: h2 }, a2;
  }
  ...
  return h.componentDidMount = function() {
    ...
    return import_react3.default.createElement("div", { ref: (e3) => {
...
function InputTitle({
  ...
  const [isMouseOver, setIsMouseOver] = (0, import_react4.useState)(false);
...
function Slider({
  ...
  const [sharedValue, setSharedValue] = (0, import_react5.useState)(defaultValue);
...
function useEventCallback(handler) {
  var callbackRef = (0, import_react6.useRef)(handler);
  (0, import_react6.useEffect)(() => {
    callbackRef.current = handler;
  });
  return (0, import_react6.useCallback)((value, event) => callbackRef.current && callbackRef.current(value, event), []);
}
...
var Interactive = /* @__PURE__ */ import_react7.default.forwardRef((props, ref) => {
  var {
  ...
  var container = (0, import_react7.useRef)(null);
  var hasTouched = (0, import_react7.useRef)(false);
  var [isDragging, setDragging] = (0, import_react7.useState)(false);
  ...
  var handleMove = (0, import_react7.useCallback)((event) => {
  ...
  var handleMoveEnd = (0, import_react7.useCallback)(() => setDragging(false), []);
  var toggleDocumentEvents = (0, import_react7.useCallback)((state) => {
  ...
  var handleMoveStart = (0, import_react7.useCallback)((event) => {
...
var Alpha = /* @__PURE__ */ import_react9.default.forwardRef((props, ref) => {
  var {
...
var ShadeSlider = /* @__PURE__ */ import_react10.default.forwardRef((props, ref) => {
  var {
...
var Wheel = /* @__PURE__ */ import_react12.default.forwardRef((props, ref) => {
  var {
...
function RangeSlider({
  ...
  const [rangeValue, setRangeValue] = (0, import_react13.useState)(defaultValue);
  const [isMouseOver, setIsMouseOver] = (0, import_react13.useState)(false);
