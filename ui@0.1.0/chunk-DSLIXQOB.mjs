...
var { useQueryState, useURLQueryState } = ui;
  ...
  return (_a) => {
    ...
    return /* @__PURE__ */ jsx(
      ...
      __spreadProps(__spreadValues({}, props), {
        style: __spreadProps(__spreadValues({}, style), { cursor: enabled ? "pointer" : "default", opacity: enabled ? 1 : 0.5, PointerEvent: enabled ? "auto" : "none" }),
        onClick: () => {
...
function goBack(Component) {
  return (props) => {
    ...
    const setFigmaPage = useUIStore((state) => state.setFigmaPage);
    return /* @__PURE__ */ jsx(Component, __spreadProps(__spreadValues({}, props), { onClick: () => {
      controller.abort();
