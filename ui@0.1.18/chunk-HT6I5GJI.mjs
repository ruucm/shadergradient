...
function CopyBtn(Component) {
  return (props) => {
    ...
    return /* @__PURE__ */ jsx(
      Component,
      __spreadProps(__spreadValues({}, props), {
        btnText: `${copied === false ? "Copy " : "Yay, copied "}${store.share === "url" ? "URL" : "code"}${copied === false ? "" : "!"}`,
...
function HighlightButton(Component) {
  return (props) => {
    ...
    return /* @__PURE__ */ jsx(
      Component,
      __spreadProps(__spreadValues({}, props), {
        variant: store.currentTab === 3 && store.easyView === false ? "ToggleBtn - Highlight" : store.easyView === true ? "ToggleBtn - Clicked" : "ToggleBtn - Default",
        onClick: () => {
...
function EasyViewControl(Component) {
  return (props) => {
    const [store, setStore] = useStore();
    return /* @__PURE__ */ jsx(
      Component,
