...
function useDBTable(table, channelName = "any", filter) {
  ...
  useEffect(() => {
    ...
    console.log(
      `[useDBTable] Fetching initial data for table: ${table}`,
  ...
  }, [table, filter == null ? void 0 : filter.column, filter == null ? void 0 : filter.value, supabase]);
  useEffect(() => {
    if (!supabase) return;
    if (filter && (filter.value === void 0 || filter.value === null)) {
      return;
  ...
  }, [table, channelName, filter == null ? void 0 : filter.column, filter == null ? void 0 : filter.value, supabase]);
  function updateRow(updates) {
    return __async(this, null, function* () {
      if (!supabase) {
        console.warn("[useDBTable] Supabase client not initialized");
        return;
      }
