...
declare const useScrollableBoxStore: zustand.UseBoundStore<Omit<zustand.StoreApi<ScrollableBoxState>, "persist"> & {
    persist: {
        setOptions: (options: Partial<zustand_middleware.PersistOptions<ScrollableBoxState, ScrollableBoxState>>) => void;
        clearStorage: () => void;
        rehydrate: () => Promise<void> | void;
        hasHydrated: () => boolean;
        onHydrate: (fn: (state: ScrollableBoxState) => void) => () => void;
        onFinishHydration: (fn: (state: ScrollableBoxState) => void) => () => void;
        getOptions: () => Partial<zustand_middleware.PersistOptions<ScrollableBoxState, ScrollableBoxState>>;
    };
}>;
type FigmaUser = {
    id?: string;
...
declare const useFigmaStore: zustand.UseBoundStore<zustand.StoreApi<FigmaStore>>;
declare function useFigma(): [FigmaState, FigmaStore['setFigma']];
...
declare const useBillingIntervalStore: zustand.UseBoundStore<zustand.StoreApi<BillingIntervalState>>;
declare function useBillingInterval(): [
...
declare function TextAnimation({ fontSize, color, content, delay, width, yBefore, fontFamily, hiddenOpacity, }: {
    fontSize: any;
    color: any;
    content: any;
    delay?: number;
...
declare function memoryUsage(Component: any): ComponentType;
...
declare function ConnectFigmaMessage(Component: any): ComponentType;
