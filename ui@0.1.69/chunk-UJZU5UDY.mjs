...
function signInOrSignUp(supabase, email, figmaUserId) {
  return __async(this, null, function* () {
    var _a, _b;
    if (!supabase || !email || !figmaUserId) return null;
    try {
      const { data: signInData, error: signInError } = yield supabase.auth.signInWithPassword({
        email,
      ...
      if (!signInError && (signInData == null ? void 0 : signInData.session)) {
        console.log(
          ...
          (_a = signInData.user) == null ? void 0 : _a.id
        );
        return signInData;
      }
      ...
      console.log(
        ...
        (_b = signUpData == null ? void 0 : signUpData.user) == null ? void 0 : _b.id
      );
      return signUpData;
    } catch (err) {
...
function useEnsureAuthSignUp() {
  ...
  useEffect(() => {
    var _a2;
    if ((userDB == null ? void 0 : userDB.email) && ((_a2 = figma.user) == null ? void 0 : _a2.id) && supabase && !calledRef.current) {
      calledRef.current = true;
      signInOrSignUp(supabase, userDB.email, figma.user.id);
    }
  }, [userDB == null ? void 0 : userDB.email, (_a = figma.user) == null ? void 0 : _a.id, supabase]);
}
