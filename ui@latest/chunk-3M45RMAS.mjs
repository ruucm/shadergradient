...
function signUpToSupabaseAuth(supabase, email) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      console.log(
        ...
        (_b = data == null ? void 0 : data.user) == null ? void 0 : _b.id
      );
    } catch (err) {
...
function useEnsureAuthSignUp() {
  ...
  useEffect(() => {
    if ((userDB == null ? void 0 : userDB.email) && supabase && !calledRef.current) {
      calledRef.current = true;
      signUpToSupabaseAuth(supabase, userDB.email);
    }
  }, [userDB == null ? void 0 : userDB.email, supabase]);
}
