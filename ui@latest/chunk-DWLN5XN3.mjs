...
function extractGIF(Component) {
  return (_a) => {
    ...
    const supportsVideoOnCanvas = figma2.editorType === "slides" || figma2.editorType === "buzz";
    useEffect(() => {
    ...
    useEffect(() => {
      setSize(
        estimateSize({
          ...
          duration,
          frameRate,
          nodeWidth: figma2.nodeWidth,
          nodeHeight: figma2.nodeHeight
        })
      );
      setTimeout(() => {
    ...
    const effectiveRangeEnd = loop === "on" && loopDuration ? loopDuration : rangeEnd;
...
function Timeline(Component) {
  return (_a) => {
    ...
    useEffect(() => {
      if (loop === "on" && loopDuration) {
        setDuration(loopDuration);
      } else if (rangeStart !== void 0 && rangeEnd !== void 0) {
        setDuration(rangeEnd - rangeStart);
      }
    }, [rangeStart, rangeEnd, loop, loopDuration]);
    useEffect(() => {
      const runSequence = () => __async(null, null, function* () {
        try {
...
function EstimatedSize(Component) {
  return (_a) => {
    ...
    }, [format, duration, frameRate, figma2.nodeWidth, figma2.nodeHeight]);
    useEffect(() => {
    ...
    return /* @__PURE__ */ jsx(
      ...
      __spreadProps(__spreadValues({}, props), {
        ...
        onClickUrl: () => {
          var _a2;
          setShare("url");
          (_a2 = props.onClickUrl) == null ? void 0 : _a2.call(props);
        },
        onClickCode: () => {
          var _a2;
          setShare("code");
          (_a2 = props.onClickCode) == null ? void 0 : _a2.call(props);
        }
      })
    );
  };
...
function EasyViewInfo(Component) {
  return (props) => {
    const easyView = useFigmaPluginStore((state) => state.easyView);
    return /* @__PURE__ */ jsx(
      "div",
...
function StatelessOverride(Component) {
  return (props) => {
    ...
    useEffect(() => {
      if (range === "enabled" && (loop === void 0 || loop === null)) {
        setLoop("on");
        if (rangeEnd && (loopDuration === void 0 || loopDuration === null)) {
          setLoopDuration(rangeEnd);
        }
      } else if (loop === void 0 || loop === null) {
        setLoop("on");
      }
...
function ConnectFigmaMessage(Component) {
  return (props) => {
    useFigmaMessage();
...
function FigmaUrlInput(Component) {
  return (props) => {
    const setQueryValue = useURLQueryState();
...
function DestinationControl(Component) {
  return (_a) => {
    var _b = _a, { style } = _b, props = __objRest(_b, ["style"]);
    ...
    return /* @__PURE__ */ jsx(
      Component,
      __spreadProps(__spreadValues({}, props), {
        style: __spreadProps(__spreadValues({}, style), { width: "100%" }),
...
function FormatControl(Component) {
  return (_a) => {
    var _b = _a, { style } = _b, props = __objRest(_b, ["style"]);
    const [figma2] = useFigma();
    const [destination] = useQueryState("destination");
    ...
    const supportsVideoOnCanvas = figma2.editorType === "slides" || figma2.editorType === "buzz";
    const showFormatControl = destination === "localFile" || supportsVideoOnCanvas;
    useEffect(() => {
...
function ExportLoadingOverlay(Component) {
  return (props) => {
